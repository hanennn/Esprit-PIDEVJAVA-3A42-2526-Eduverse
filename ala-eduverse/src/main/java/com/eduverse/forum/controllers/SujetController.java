...
public class SujetController {
    ...
    private void refreshList() {
        try {
            ...
            for (Sujet sujet : sujets) {
                cards.add(createSubjectCard(sujet));
            }
            if (cards.isEmpty()) {
    ...
    private VBox createSubjectCard(Sujet sujet) {
        User currentUser = AppContext.getCurrentUser();
        boolean canEdit = currentUser != null && (currentUser.hasRole("ROLE_ADMIN") || currentUser.getId() == sujet.getAuteurId());
        ...
        if (sujet.getImageUrl() != null && !sujet.getImageUrl().isEmpty()) {
            javafx.scene.image.ImageView imageView = new javafx.scene.image.ImageView(sujet.getImageUrl());
    ...
    private void handleSave() {
        ...
        if (selectedImageFile != null) {
            ...
            imageUrl = com.eduverse.forum.utils.ImageKitUtil.uploadImage(selectedImageFile);
            if (imageUrl == null) {
    ...
    private void handleTranslate() {
        ...
        Task<String> task = new Task<>() {
            ...
            protected String call() {
                return com.eduverse.forum.utils.TranslateUtil.translate(text);
            }
        };
