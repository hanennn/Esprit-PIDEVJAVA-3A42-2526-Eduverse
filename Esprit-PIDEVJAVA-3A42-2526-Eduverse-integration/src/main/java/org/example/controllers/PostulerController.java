...
public class PostulerController {
    ...
    private void soumettreDemande(ActionEvent event) {
        ...
        d.setEtudiant_id(Session.getCurrentUser().getId());
    ...
    private boolean validerFormulaire() {
        ...
        boolean alreadyApplied = service.getAll().stream()
                .anyMatch(d -> d.getEtudiant_id() == Session.getCurrentUser().getId() && d.getBourse_id() == bourseConcernee.getId());
    ...
    private void retourListe() {
        naviguerVers("/org/example/etudiant/EtudiantBourses.fxml");
    }

    @FXML
    private void allerCalendrier(ActionEvent event) { naviguerVers("/org/example/etudiant/CalendrierBourses.fxml"); }
    @FXML
    ...
    @FXML
    private void allerInterviewIA(ActionEvent event) { naviguerVers("/org/example/etudiant/InterviewEtudiant.fxml"); }
