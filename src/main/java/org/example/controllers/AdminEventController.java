...
public class AdminEventController {
        ...
        try {
            ...
            if (list.length() > 0) {
                ...
                if (descLower.contains("pluie") || descLower.contains("orage") || descLower.contains("neige")
                    ...
                    lblWeatherWarning.setText("Attention : Mauvaises conditions météo prévues (" + description
    ...
    private void handleSearchMap(ActionEvent event) {
        ...
        Task<JSONObject> searchTask = new Task<JSONObject>() {
            ...
            protected JSONObject call() throws Exception {
                ...
                HttpRequest request = HttpRequest.newBuilder()
                        .uri(URI.create(url))
                        .header("User-Agent", "EduverseApp/1.0")
                        .build();
    ...
    public void prefillFromAISuggestion(String titre, String desc, String lieu, String type, String niveau) {
    ...
    void logout(ActionEvent event) {
        try {
            ...
            tvEvents.getScene().setRoot(root);
        } catch (Exception e) {
