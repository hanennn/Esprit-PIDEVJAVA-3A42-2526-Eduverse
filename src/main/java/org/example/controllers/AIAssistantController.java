...
public class AIAssistantController {
    ...
    private static final String GROQ_API_KEY = "your_groq_api_key_here"; // To be set by environment or manually
    ...
    private void handleCreerEvenement(ActionEvent event) {
        ...
        try {
            ...
            if (content != null) {
                AdminEventController ec = (AdminEventController) content.getProperties()
                        .get("fx:controller");
                if (ec == null) {
                    Object userData = content.getUserData();
                    if (userData instanceof AdminEventController) {
                        ec = (AdminEventController) userData;
                    }
                }
                if (ec != null) {
