...
public class BadwordController {
    ...
    @FXML
    void goToAdminUser(javafx.scene.input.MouseEvent event) throws java.io.IOException {
        javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("/AdminView.fxml"));
        javafx.scene.Parent root = loader.load();
        ((javafx.scene.Node) event.getSource()).getScene().setRoot(root);
    }
    ...
    @FXML
    void goToAdminCours(javafx.scene.input.MouseEvent event) throws java.io.IOException {
    ...
    @FXML
    void goToAdminCertification(javafx.scene.input.MouseEvent event) throws java.io.IOException {
        javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("/CertifAdmin.fxml"));
        javafx.scene.Parent root = loader.load();
        ((javafx.scene.Node) event.getSource()).getScene().setRoot(root);
    }

    @FXML
    void goToAdminQuiz(javafx.scene.input.MouseEvent event) throws java.io.IOException {
        javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("/org/example/AdminQuiz.fxml"));
        javafx.scene.Parent root = loader.load();
        ((javafx.scene.Node) event.getSource()).getScene().setRoot(root);
    }

    @FXML
    void goToAdminForum(javafx.scene.input.MouseEvent event) throws java.io.IOException {
        javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("/main.fxml"));
        javafx.scene.Parent root = loader.load();
        
        MainController mainController = loader.getController();
        mainController.setCurrentUser(org.example.utils.AppContext.getCurrentUser());
