...
public class GoogleOAuthService {
    ...
    /**
     * Finds a free port from a list of candidates.
     */
    ...
    /**
     * Launches the browser, starts a local callback server,
     * and returns a CompletableFuture that resolves with GoogleUserInfo
