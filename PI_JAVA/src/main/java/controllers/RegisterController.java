...
public class RegisterController {
                ...
                javafx.application.Platform.runLater(() -> {
                    try {
                        if (new AdminService().EmailExists(userInfo.email)) {
                            entities.Session.loginWithGoogle(userInfo);
    ...
    private void navigateAfterLogin(ActionEvent event) throws IOException {
        entities.User user = entities.Session.getCurrentUser();
        ...
        String fxml = user instanceof entities.Professor ? "/ProfessorView.fxml" : "/StudentView.fxml";
